...
export default function Cards() {
  return (
    <div className="cards">
      ...
      <Card image={Placeholder} category="Placeholder" title="Future Project" description="Lorem ipsum dolor sit amet." /> 
      <Card image={Image2} category="Placeholder" title="Future Project" description="Lorem ipsum dolor sit amet." />
    </div>
  )
}
